...
<div class="container">
    ...
    <div class="carousel-container">
	    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
	        ...
	        <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev" style="left: 0;">
	            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
	            <span class="visually-hidden">Previous</span>
	        </button>
	        <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next" style="right: 0;">
    ...
    <div class="content-container">
        ...
        <div class="side-container">
            <iframe src="http://<%=ip_adress %>:5000/kospi_kosdaq" width="550px" height="500px" frameborder="0"></iframe>
            <div class="card mt-4">
                <div class="card-body">
                    <!-- 검색 입력 필드와 버튼 -->
